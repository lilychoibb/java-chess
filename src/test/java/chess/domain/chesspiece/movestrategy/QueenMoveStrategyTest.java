...
class QueenMoveStrategyTest {
    ...
    void 목적지가_Queen이_움직일_수_있는_범위이면_움직인다() {
        chessBoard.move(new Square(Lettering.D, Numbering.ONE), new Square(Lettering.D, Numbering.SIX));
    ...
    void 목적지가_Queen이_움직일_수_있는_범위가_아니면_움직이지_않는다() {
        chessBoard.move(new Square(Lettering.D, Numbering.ONE), new Square(Lettering.B, Numbering.THREE));
